...
public class Contexto<T> {
     ...
     *
     * @throws VariavelJaDeclaradaException se j� existir um mapeamento do identificador nesta tabela.
     */
     ...
     *
     * @throws VariavelNaoDeclaradaException se n�o existir nenhum valor mapeado ao id dado nesta
     *                                       tabela.
     */
